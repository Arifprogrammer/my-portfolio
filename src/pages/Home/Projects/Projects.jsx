      ...
      <section className="my-16 lg:my-20 px-4 lg:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-6 lg:gap-y-0 lg:gap-x-4 relative">
              ...
              <Fade delay={500} duration={2500}>
                <div className="h-[27.2rem] overflow-hidden">
                  <p>
                    ...
                    athlete classes for students during their summer vacations.
                    It also allows instructors to effortlessly add and manage
                    their classes. The system includes a secure payment
                    integration, enabling students to conveniently pay for their
                    chosen classes. Additionally, an admin panel is available
                    for effective user and class management. Experience a
                    streamlined platform that connects athletes with their
                    desired classes. Start optimizing your athletic journey
                    today!
                  </p>
          ...
          {details && (
            ...
            >
              <div className="h-[27.2rem] overflow-hidden">
                <div className="absolute top-2/4 -right-44 hidden lg:block">
                  <Link
                ...
                <Fade delay={1000} duration={2500}>
                  ...
                  <p>
                    ...
                    class descriptions, schedules, and requirements.
                    Additionally, instructors can view the status of their
                    classes, such as approved, denied, or pending, allowing them
                    to track their offerings effectively.
                  </p>
                  <p>
                    <span className="font-bold text-neutral">
                      Admin Control Panel:
                    </span>{" "}
                    The admin role has access to a control panel that grants
                    them complete control over user management and class
                    organization. Admins can manage user roles, including
                    assigning student and instructor privileges, and have the
                    authority to approve or deny class requests.
                  </p>
                </Fade>
              </div>
            </div>
